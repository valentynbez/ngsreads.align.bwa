...
setuptools.setup(
    ext_modules=[
        Extension(
            ...
            language="c++",
            sources=[
                os.path.join("vendor", "strobealign", "src", "refs.cpp"),
                os.path.join("vendor", "strobealign", "src", "fastq.cpp"),
                os.path.join("vendor", "strobealign", "src", "cmdline.cpp"),
                os.path.join("vendor", "strobealign", "src", "index.cpp"),
                os.path.join("vendor", "strobealign", "src", "indexparameters.cpp"),
                os.path.join("vendor", "strobealign", "src", "sam.cpp"),
                os.path.join("vendor", "strobealign", "src", "paf.cpp"),
                os.path.join("vendor", "strobealign", "src", "pc.cpp"),
                os.path.join("vendor", "strobealign", "src", "aln.cpp"),
                os.path.join("vendor", "strobealign", "src", "cigar.cpp"),
                os.path.join("vendor", "strobealign", "src", "aligner.cpp"),
                os.path.join("vendor", "strobealign", "src", "nam.cpp"),
                os.path.join("vendor", "strobealign", "src", "randstrobes.cpp"),
                os.path.join("vendor", "strobealign", "src", "readlen.cpp"),
                os.path.join("vendor", "strobealign", "src", "version.cpp"),
                os.path.join("vendor", "strobealign", "src", "io.cpp"),
                os.path.join("vendor", "strobealign", "ext", "xxhash.c"),
                os.path.join("vendor", "strobealign", "ext", "ssw", "ssw_cpp.cpp"),
                os.path.join("vendor", "strobealign", "ext", "ssw", "ssw.c"),
                os.path.join("ngsreads", "align", "strobealign.pyx"),
            ],
            include_dirs=[
                "include",
                SETUP_FOLDER,
                os.path.join("vendor", "zstr", "src"),
            ],
            libraries=["z"],
        ),
    ],
